...
کاربر سطح ۲ (مدیر پروژه/نیروگاه) اکنون از منوی اصلی می‌تواند مستقیماً
پیمانکاران پروژهٔ خودش را ببیند و درخواست خاتمهٔ همکاری بدهد. رفع یک باگ
که باعث می‌شد این دکمه هرگز برای سطح ۲ نمایش داده نشود. جزئیات در
CONTRACTS.md بخش «فاز ۱۲».
Private Project
